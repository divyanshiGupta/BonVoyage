...
try
{
	...
	String Qry = "select a.RouteId,b.Travels,b.AgentName,b.PhoneNumber,c.BusType,c.BusNumber,a.Fare,a.Departure,a.Arrival,a.TravelsId,a.BusId from routemaster a left join travelsmaster b on (a.TravelsId=b.TravelsId ) left join busmaster c on (a.BusId=c.BusId and c.BusType in ("+BusTypeCondition+")) where  a.rFrom='"+rFrom+"' and a.rTo='"+rTo+"' and a.JDate='"+JDate+"' and a.Availability >= "+NoPass;
