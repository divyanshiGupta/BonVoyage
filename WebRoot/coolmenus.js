...
oCMenu.offlineUrl="file:///C:\Program Files\Apache Group\Tomcat 4.1\webapps\ewheelz" //Value: "path_to_menu_file_offline/"
...
oCMenu.fromtop=10 //This is the top position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.makeMenu('top','','<b>&nbsp;Home</b>','Result.html','ResultFrame',120,30,"Images/Menu/Home1.jpg","Images/Menu/Home2.jpg")
oCMenu.makeMenu('top1','','<b>&nbsp;Cancel</b>','CancelTicket_S1.jsp','ResultFrame',120,30,"Images/Menu/Cancel1.jpg","Images/Menu/Cancel2.jpg")//,0,0,"","",'red','silver')
oCMenu.makeMenu('top2','','<b>&nbsp;Testimonials</b>','Feedback.jsp','ResultFrame',120,30,"Images/Menu/Testimonials1.jpg","Images/Menu/Testimonials2.jpg")//,0,0,"","",'red','silver')
//oCMenu.makeMenu('top3','','<b>&nbsp;Logout</b>','Logout.jsp','_Top',120,30,"Images/Menu/Logout1.jpg","Images/Menu/Logout2.jpg")//,0,0,"","",'red','silver')
